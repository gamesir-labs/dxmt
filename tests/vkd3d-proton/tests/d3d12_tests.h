...
decl_test(test_descriptor_tables_execute_indirect);
decl_test(test_descriptor_table_compute_copy);
...
decl_test(test_dxmt_sparse_descriptor_smoke);
...
decl_test(test_dxmt_mixed_encoder_stress);
decl_test(test_dxmt_fence_only_barrier_chain);
decl_test(test_dxmt_resource_initializer_lifetime);
