...
// Public D3D11 non-array Texture1D RTV descriptor coverage. Two compatible
...
constexpr std::uint32_t kTexture1dRtvDescCaseCount = 16;

const dxmt::test::LogicalCaseFamilyRegistration kTexture1dRtvDescCases(
    "D3D11Texture1DSingleRenderTargetViewDescMatrixSpec."
    "RoundTrips16FormatMipSlices",
    "D3D11.RTV.Texture1D.Description.", kTexture1dRtvDescCaseCount, 2,
...
const dxmt::test::TestCostRegistration
    kTexture1dRtvDescCost("D3D11Texture1DSingleRenderTargetViewDescMatrixSpec."
                          "RoundTrips16FormatMipSlices",
                          dxmt::test::kResourceTestCost);
...
Texture1dRtvDescCase CaseForLogical(std::uint32_t logical) {
  ...
  test_case.desc.ViewDimension = D3D11_RTV_DIMENSION_TEXTURE1D;
...
class D3D11Texture1DSingleRenderTargetViewDescMatrixSpec
    : public ::testing::Test {
protected:
  void SetUp() override {
...
TEST_F(D3D11Texture1DSingleRenderTargetViewDescMatrixSpec,
       RoundTrips16FormatMipSlices) {
