...
// Public D3D11 Texture1DArray DSV descriptor coverage. Read-only flags, mip
...
constexpr std::uint32_t kTexture1dDsvDescCaseCount = 4096;

const dxmt::test::LogicalCaseFamilyRegistration kTexture1dDsvDescCases(
    "D3D11Texture1DDepthStencilViewDescMatrixSpec."
    "RoundTrips4096MipArrayRanges",
    "D3D11.DSV.Texture1DArray.Description.", kTexture1dDsvDescCaseCount, 4,
...
const dxmt::test::TestCostRegistration
    kTexture1dDsvDescCost("D3D11Texture1DDepthStencilViewDescMatrixSpec."
                          "RoundTrips4096MipArrayRanges",
                          dxmt::test::kResourceTestCost);
...
Texture1dDsvDescCase CaseForLogical(std::uint32_t logical) {
  ...
  test_case.desc.ViewDimension = D3D11_DSV_DIMENSION_TEXTURE1DARRAY;
...
class D3D11Texture1DDepthStencilViewDescMatrixSpec : public ::testing::Test {
protected:
  void SetUp() override {
...
TEST_F(D3D11Texture1DDepthStencilViewDescMatrixSpec,
       RoundTrips4096MipArrayRanges) {
...
TEST_F(D3D11Texture1DDepthStencilViewDescMatrixSpec,
  ...
  past_end.Texture1DArray.ArraySize = 16;
