...
// Public D3D11 Texture1DArray UAV descriptor coverage. Typed formats, mip
...
constexpr std::uint32_t kTexture1dUavDescCaseCount = 4096;

const dxmt::test::LogicalCaseFamilyRegistration kTexture1dUavDescCases(
    "D3D11Texture1DUnorderedAccessViewDescMatrixSpec."
    "RoundTrips4096MipArrayRanges",
    "D3D11.UAV.Texture1DArray.Description.", kTexture1dUavDescCaseCount, 4,
    {dxmt::test::TestClass::Conformance,
     ...
     "create every combination of two core R32 typed formats, eight mip "
...
const dxmt::test::TestCostRegistration
    kTexture1dUavDescCost("D3D11Texture1DUnorderedAccessViewDescMatrixSpec."
                          "RoundTrips4096MipArrayRanges",
                          dxmt::test::kResourceTestCost);
...
Texture1dUavDescCase CaseForLogical(std::uint32_t logical) {
  ...
  test_case.desc.ViewDimension = D3D11_UAV_DIMENSION_TEXTURE1DARRAY;
...
class D3D11Texture1DUnorderedAccessViewDescMatrixSpec : public ::testing::Test {
protected:
  void SetUp() override {
...
TEST_F(D3D11Texture1DUnorderedAccessViewDescMatrixSpec,
       RoundTrips4096MipArrayRanges) {
