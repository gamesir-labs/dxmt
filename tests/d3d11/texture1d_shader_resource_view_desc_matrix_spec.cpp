...
// Public D3D11 Texture1DArray SRV descriptor coverage. Compatible formats,
...
constexpr std::uint32_t kTexture1dSrvDescCaseCount = 4096;

const dxmt::test::LogicalCaseFamilyRegistration kTexture1dSrvDescCases(
    "D3D11Texture1DShaderResourceViewDescMatrixSpec."
    "RoundTrips4096MipArrayRanges",
    "D3D11.SRV.Texture1DArray.Description.", kTexture1dSrvDescCaseCount, 4,
    {dxmt::test::TestClass::Conformance,
     ...
     "eight array sizes, then query the complete public descriptor and "
     "relationships",
...
const dxmt::test::TestCostRegistration
    kTexture1dSrvDescCost("D3D11Texture1DShaderResourceViewDescMatrixSpec."
                          "RoundTrips4096MipArrayRanges",
                          dxmt::test::kResourceTestCost);
...
Texture1dSrvDescCase CaseForLogical(std::uint32_t logical) {
  ...
  test_case.desc.ViewDimension = D3D11_SRV_DIMENSION_TEXTURE1DARRAY;
  test_case.desc.Texture1DArray.MostDetailedMip = test_case.mip_start_index;
  test_case.desc.Texture1DArray.MipLevels = test_case.mip_count_index + 1u;
...
bool Texture1dSrvDescsEqual(const D3D11_SHADER_RESOURCE_VIEW_DESC &actual,
  ...
  return actual.Format == expected.Format &&
         ...
         actual.Texture1DArray.MostDetailedMip ==
             expected.Texture1DArray.MostDetailedMip &&
         actual.Texture1DArray.MipLevels == expected.Texture1DArray.MipLevels &&
...
class D3D11Texture1DShaderResourceViewDescMatrixSpec : public ::testing::Test {
protected:
  void SetUp() override {
...
TEST_F(D3D11Texture1DShaderResourceViewDescMatrixSpec,
       RoundTrips4096MipArrayRanges) {
  ...
  for (const std::uint32_t logical : selected_cases) {
    ...
    ADD_FAILURE()
        ...
        << " mip_start=" << test_case.desc.Texture1DArray.MostDetailedMip
        << " mip_count=" << test_case.desc.Texture1DArray.MipLevels
        ...
        << " mip_start=" << actual.Texture1DArray.MostDetailedMip
        << " mip_count=" << actual.Texture1DArray.MipLevels
...
TEST_F(D3D11Texture1DShaderResourceViewDescMatrixSpec,
  ...
  past_end.Texture1DArray.FirstArraySlice = 9;
  past_end.Texture1DArray.ArraySize = 8;
