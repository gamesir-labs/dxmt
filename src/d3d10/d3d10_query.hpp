...
class MTLD3D10Counter final : public ID3D10Counter {

public:
  MTLD3D10Counter(ID3D11Counter *d3d11, ID3D11DeviceContext *d3d11_context)
      : d3d11(d3d11), d3d11_context(d3d11_context) {}
  ...
  void STDMETHODCALLTYPE
  GetDesc(D3D10_COUNTER_DESC *pDesc) {
    D3D11_COUNTER_DESC d3d11_desc;
    d3d11->GetDesc(&d3d11_desc);

    pDesc->Counter = D3D10_COUNTER(d3d11_desc.Counter);
    pDesc->MiscFlags = d3d11_desc.MiscFlags;
  }
};
