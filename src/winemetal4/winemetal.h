...
struct WMTMTL4TimestampHeapEntry {
  uint64_t timestamp;
};

WINEMETAL_API obj_handle_t MTL4CounterHeap_newTimestampHeap(obj_handle_t device, uint64_t count, obj_handle_t *err_out);

WINEMETAL_API void MTL4CounterHeap_resolveCounterRange(
...
WINEMETAL_API void MTL4TimestampContext_writeTimestamp(
    obj_handle_t context, obj_handle_t cmdbuf, obj_handle_t heap, uint64_t index
);
