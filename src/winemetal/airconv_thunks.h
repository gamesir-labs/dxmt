...
enum airconv_unixcalls {
  ...
  // 151..155. Sits immediately after upstream's apitrace + sparse + heap
  // dispatcher entries (136..150) in winemetal_unix.c. Keep in lock-step with the
