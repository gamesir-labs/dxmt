...
// D3D9StateBlockChanges is defined in d3d9_device.hpp next to the
// storage sizes it mirrors; the device's recording arms mark bits on
// the block's instance directly.
