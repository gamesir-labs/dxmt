...
void recordFrameBoundary(uint64_t frame, const FrameStatistics &frame_stats,
  ...
  Logger::logFileOnly(
      ...
      str::format("DXMT perf frame: buildVersion=", DXMT_VERSION,
                  ...
                  " submittedDescriptorSpanLookups=",
                  frame_stats.frame_submitted_descriptor_span_lookups,
                  " submittedDescriptorUniqueSpans=",
                  frame_stats.frame_submitted_descriptor_unique_spans,
                  " submittedDescriptorSpanReuses=",
                  frame_stats.frame_submitted_descriptor_span_reuses,
