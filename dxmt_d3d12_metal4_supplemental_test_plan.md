...
截至第八轮，新增 `shader/system_value_spec.cpp` 的 5 个离屏执行 case：
...
缺口，并直接覆盖 DXMT 的 DXBC -> Metal system-value 转换。尚待补齐
SampleIndex/Coverage、depth variants、插值/packing 矩阵和 DXIL parity。
